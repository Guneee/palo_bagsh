...
const Color kPrimaryColor = Color(0xFF00B267);
const Color kBtnColor = Color(0xFF00B267);
const Color kBtn2Color = Color(0xFF72DC60);
const Color kTextColor = Color(0xFF28293D);
